...
export function Pricing({ isDark }: PricingProps) {
  const tiers = [
    {
      name: "Starter",
      icon: SparklesIcon,
      ...
      period: "/month",
      description:
        "Perfect for small mortgage brokerages getting started with AI",
      features: [
    ...
    },
    {
      ...
      features: [
        ...
        "Internal analytics platform access",
        "API access",
    ...
    >
      <div className="max-w-7xl mx-auto">
          ...
          {tiers.map((tier, index) => (
            <div
              ...
              className={`relative p-8 rounded-2xl ${
                tier.highlighted
                  ? isDark
                    ? "bg-gradient-to-b from-blue-900/30 to-purple-900/30 border-blue-500/50 shadow-2xl shadow-blue-500/20"
                    : "bg-gradient-to-b from-red-50 to-orange-50 border-red-300 shadow-2xl shadow-red-500/20"
                  : isDark
                  ? "bg-slate-800/50 border-slate-700"
                  : "bg-white border-gray-200"
              } border ${tier.highlighted ? "transform scale-105" : ""}`}
            >
              {tier.badge && (
                <div
        ...
        >
          ...
          >
            All plans include: 99.9% uptime SLA, data encryption, and regular
            security audits
          </p>
