...
export function Hero({ isDark }: Readonly<HeroProps>) {
  return (
    <div
    ...
    >
      ...
      <div
        className={`absolute top-0 left-1/4 w-96 h-96 ${
          isDark ? "bg-blue-500/20" : "bg-red-500/20"
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <a
            ...
            className={`px-8 py-4 ${
              ...
              isDark ? "text-white" : "text-gray-900"
            } rounded-lg font-semibold backdrop-blur-sm border transition-all no-underline`}
          >
            Schedule Demo
          </a>
        </div>
